...
public class RobotMap {
    ...
    public static Relay pneumatics;
    public static Relay gripper;
	...
	LiveWindow.addActuator("Drive", "Speed Controller Right", (Victor) driveSpeedControllerRight);
        ...
        pneumatics = new Relay(1);
        LiveWindow.addActuator("Drive", "Pneumatics", (Relay) pneumatics);
        
        gripper = new Relay(2);
        LiveWindow.addActuator("Drive", "Gripper", (Relay) gripper);
